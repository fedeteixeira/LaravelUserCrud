                ...
                <div class="card-body border-0">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea maxlength="200" id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" required autocomplete="description" autofocus>
                                </textarea>
                        ...
                        <div class="form-group row">
                            <label for="profile-picture" class="col-md-4 col-form-label text-md-right text-light">{{ __('Profile Picture') }}</label>

                            <div class="col-md-6">
                                <input id="profile-picture" type="file" class="form-control-file text-light" name="image">
                            </div>
                        </div>
